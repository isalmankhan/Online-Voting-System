...
tablename = partyname+"mla"; 
persondetails = "select * from "+tablename+" where name='"+nameofperson+"'";
...
<tbody>
<tr><th width="100%" align=left><%=partyname%> Party Member</th></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
...
<table border="3" bordercolor="#453446">
<tr>
<td align="center"><font size="4">NAME</font></td>
<td align="center"><font size="4">AGE</font></td>
<td align="center"><font size="4">BIRTH PLACE</font></td>
<td align="center"><font size="4">PARTICIPATING PLACE</font></td>
<td align="center"><font size="4">EDUCATIONAL BACKGROUND</font></td>
<td align="center"><font size="4">PROPERTY VALUE</font></td>
<td align="center"><font size="4">POLICE RECORD</font></td>
</tr>
<%
while(rs1.next())
{
